...
@test "It should autotune for a 512MB container" {
  ...
  run-database.sh --client "mysql://root@localhost/db" -Ee "SELECT @@innodb_buffer_pool_size/1024/1024;" | grep 256
}
